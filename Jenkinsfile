pipeline {
    ...
    environment {
        ...
        ECR_URL = '217100784311.dkr.ecr.ap-southeast-1.amazonaws.com/api-gateway-repo'
        DOCKER_IMAGE = 'apigateway'
        IMAGE_TAG = 'v1'
    }
    stages {
        stage('Checkout') {
            steps {
                ...
                git url: 'https://github.com/Runner-app-org/api-gateway.git', branch: 'master'
            }
        }
